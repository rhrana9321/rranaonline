...
class Dashboard extends CI_Controller {
    ...
    public function index() {
        ...
        $this->load->view('superadmin/dashboardpage', $data);
    }
	...
	public function All_collection() {
        ...
        $user_id = $this->session->userdata('userid');
        $data['superdetails'] = $this->M_cloud->findbyidstock('superadmin', array('id' => $user_id));
		$data['results_paymentinfo'] = $this->M_cloud->findAll('payment_table', 'payment_id asc');
        $this->load->view('superadmin/All_collectionpage', $data);
    }
