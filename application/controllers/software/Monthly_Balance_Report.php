...
class Monthly_Balance_Report extends CI_Controller {
	...
	public function index()
	{
		...
		$month  = $date1[1];
		$day  	= $date1[2];
		$data['year_List'] = $this->M_cloud->year_group2('monthly_report_table', 'yearly_name asc');
		...
		//echo $cash_and_hand = ($opanning_amount+$total_income)-($total_expence); die();
		
		
		$data['monthly_bal_table_List'] = $this->M_cloud->findAlltablewhereorderbyid('monthly_report_table', array('month_name'=> $month), 'month_running_date asc');
		...
		$this->load->view('superadmin/Monthly_Balance_ReportPage', $data);
	}
	...
	public function showreport()
	{
		...
		$data['monthly_bal_table_List'] = $this->M_cloud->findAlltablewhereorderbyid('monthly_report_table', array('month_name'=> $dateMonth, 'yearly_name'=> $dateYear), 'month_running_date asc');
		
		$this->load->view('superadmin/monthly_report_show_day_and_yearWise', $data);
	}
	
	
	
	public function Bill_record_report()
	{
		$data['superdetails'] = $this->M_cloud->findbyidstock('superadmin', array('id'=> '1'));
		$data_date 	= $this->input->post('data_date');
		$data['account_table_List'] = $this->M_cloud->findAlltablewhereorderbyid('account_statement_table', array('c_date'=> $data_date, 'history_record'=> 'Bill_collection'), 'c_date asc');
		$this->load->view('superadmin/Bill_record_reportPage', $data);
	}
	
	public function Conn_charge_record_report()
	{
		$data['superdetails'] = $this->M_cloud->findbyidstock('superadmin', array('id'=> '1'));
		$data_date 	= $this->input->post('data_date');
		$data['account_table_List'] = $this->M_cloud->findAlltablewhereorderbyid('account_statement_table', array('c_date'=> $data_date, 'history_record'=> 'Connect_charge'), 'c_date asc');
		$this->load->view('superadmin/Bill_record_reportPage', $data);
	}
	
	public function Opp_charge_record_report()
	{
		$data['superdetails'] = $this->M_cloud->findbyidstock('superadmin', array('id'=> '1'));
		$data_date 	= $this->input->post('data_date');
		$data['account_table_List'] = $this->M_cloud->findAlltablewhereorderbyid('account_statement_table', array('c_date'=> $data_date, 'history_record'=> 'Opening_amount'), 'c_date asc');
		$this->load->view('superadmin/Bill_record_reportPage', $data);
	}
	
	public function Others_charge_record_report()
	{
		$data['superdetails'] = $this->M_cloud->findbyidstock('superadmin', array('id'=> '1'));
		$data_date 	= $this->input->post('data_date');
		$data['account_table_List'] = $this->M_cloud->findAlltablewhereorderbyid('account_statement_table', array('c_date'=> $data_date, 'history_record'=> 'Others_income'), 'c_date asc');
		$this->load->view('superadmin/Bill_record_reportPage', $data);
	}
	
	public function Expence_charge_record_report()
	{
		$data['superdetails'] = $this->M_cloud->findbyidstock('superadmin', array('id'=> '1'));
		$data_date 	= $this->input->post('data_date');
		$data['account_table_List'] = $this->M_cloud->findAlltablewhereorderbyid('account_statement_table', array('c_date'=> $data_date, 'history_record'=> 'Expence'), 'c_date asc');
		$this->load->view('superadmin/Bill_record_reportPage', $data);
	}
