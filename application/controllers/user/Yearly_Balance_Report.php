...
class Yearly_Balance_Report extends CI_Controller {
	...
	public function index()
	{
		...
		$data['yearly_bal_table_List'] = $this->M_cloud->yearly_m('monthly_report_table', array('month_name'=> $month, 'yearly_name'=> $year), 'month_running_date asc');
		...
		$this->load->view('user/Yearly_Balance_ReportPage', $data);
	}
