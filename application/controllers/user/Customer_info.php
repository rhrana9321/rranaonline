...
class Customer_info extends CI_Controller {
	...
	public function index()
	{
		...
		$this->load->view('user/Customer_infoPage', $data);
	}
	...
	public function print_coustomer()
	{
		...
		$data['success'] = $this->session->userdata('success');
		$this->session->set_userdata(array('success' => ''));
		$this->load->view('user/print_coustomerPage', $data);
	}
	...
	public function remarks_store()
	{
		...
		redirect('user/Customer_info/remarks/' .$customer_id);
	}
	...
	public function zoneshowreport()
	{
		...
		$this->load->view('user/zone_wise_coustomer_show', $data);
	}
