...
class Account_Statement extends CI_Controller {
	...
	public function index()
	{
		...
		$data['account_table_List'] = $this->M_cloud->findAlltablewhereorderbyid('account_statement_table', array('month_name'=> '5'), 'c_date asc');
		$data['success'] = $this->session->userdata('success');
		$this->session->set_userdata(array('success' => ''));
		$this->load->view('user/Account_StatementPage', $data);
	}
