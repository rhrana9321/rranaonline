...
class In_active_coustomer extends CI_Controller {
	...
	public function index()
	{
		...
		$this->load->view('user/In_active_coustomerPage', $data);
	}
	...
	public function zone_wise_print()
	{
		...
		$this->load->view('user/in_activezone_wise_printPage', $data);
	}
	...
	public function zoneshowreport()
	{
		...
		$this->load->view('user/inactive_all_coustomer_show', $data);
	}
	...
	public function payment_action()
	{
		...
		redirect('user/Bill_Collection/payment/' .$data['customer_id']);
