			 ...
			 <div class="modal" id="BlockModal<?php echo $v->custo_id; ?>">
						  <div class="modal-dialog">
							<div class="modal-content">
							  ...
							  <!-- Modal body -->
							  <form method="post" id="loadingId_block" enctype="multipart/form-data" action="<?php echo site_url('software/Customer_of_Other_Due/pay_now');?>"/>
                ...
                <button type="submit" name="submit_due_payment" class="btn btn-primary abc abcd">Save changes</button>
