	  ...
	  <input class="form-control" value="<?php echo $find_customer_paymentinfo->custo_id; ?>" style="height: 30px;" type="hidden" name="customer_id">
		...
		<div class="col-md-3">
          <div class="form-group">
            ...
            <input value="<?php echo $total_bill2+$total_conn_bill2; ?>" type="text" class="form-control" id="ResponsiveTitle"
                       readonly="">
          </div>
        </div>
        ...
        <div class="row" style="font-size: 12px;">
          ...
          <div class="col-md-2">
            <button id="btn_submit" style="padding: 10px !important;margin-top:23%;" type="submit"
                        class="btn btn-success abc abcd" name="submit">Add Payment </button>
          </div>
        </div>
      </form>
      <hr>
			  ...
			  ?>
                <tr>
                  ...
                  <td><div class="btn-group" >   <a target="_blank"
                                       href="#
                                       class="btn btn-xs " style="margin-left: 5px;"> <span style="color: black;" class="glyphicon glyphicon-print"></span> </a> </div></td>
                </tr>
             <?php } } ?> 
              ...
              <thead>
			   <?php
				$j = 1;
			 $total_conn_bill = 0;
			 foreach ($results_paymentconninfo as $cv) {
			 $total_conn_bill = $total_conn_bill + $cv->amount;
			 if($cv->amount > 0){
			 ?>
			 
			  <tr>
                  <td><?php echo $j++; ?></td>
                  <td><?php echo $cv->cdate_time; ?></td>
                  <td><?php echo $cv->month_name; ?></td>
                  <td style="text-align: right;">Connecting Charge</td>
                  <td style="text-align: right;"><?php echo $cv->amount; ?></td>
                  <td><div class="btn-group" >   <a target="_blank"
                                       href="#
                                       class="btn btn-xs " style="margin-left: 5px;"> <span style="color: black;" class="glyphicon glyphicon-print"></span> </a> </div></td>
                </tr>
