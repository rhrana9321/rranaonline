  ...
  <div class="col-md-12" style="margin:15px 0px 15px 0px; padding:0px 15px 0px 0px;">
    ...
    function marginchange() {
      ...
      <div class="row bg-slate-800">
        <div class="col-md-6">
          <h4><strong>View May 2020 Others Report Sheet </strong></h4>
        </div>
        <div class="col-md-6"> <a class="btn btn-success btn-sm pull-right " href="<?php echo site_url('software/Expense_Report/day_wise');?>" style="margin-top:3px;">Daywise Expense Report</a> <a class="btn btn-primary btn-sm pull-right" href="<?php echo site_url('software/Others_Income');?>" style="margin-top:3px;">Add Others Income</a>
