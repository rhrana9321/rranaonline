    ...
    <div class="col-md-10" style="background:#FFFFFF; border:1px solid #999999;">
      <div class="row">
        <div class="col-md-12 bg-teal-800">
          <h4>Edit Complane Template</h4>
        </div>
      </div>
      <div class="col-md-12"
     style=" margin-top:5px; margin-bottom: 5px; font-size:14px;  color:red; font-weight:bold; text-align: center;"> <b></b> </div>
      <div class="row">
        <form role="form" enctype="multipart/form-data" action="<?php echo site_url('software/Complain_Template/updated');?>" method="post">
		<input type="hidden" name="id" class="form-control" value="<?php echo $complain_templateList->id; ?>" id="ResponsiveTitle" placeholder="Provide Zone Name">
          <div class="col-md-6 col-md-offset-3">
            <div class="form-group">
              <label>Complain Template Details</label>
              <textarea class="form-control" name="comments" id="ResponsiveDetelis" rows="6" required><?php echo $complain_templateList->comments; ?></textarea>
            </div>
            <div class="form-group text-center">
              <button type="submit" class="btn btn-primary" name="submit">Update Complaine Template</button>
            </div>
          </div>
        </form>
      </div>
