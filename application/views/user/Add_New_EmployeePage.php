  ...
  <div class="col-md-12" style="margin:15px 0px 15px 0px; padding:0px 15px 0px 0px;">
    ...
    <div class=" panel-body col-md-12 bg-teal-800 text-center" style="margin-bottom:5px;">
      ...
      <div class="row" style="padding:10px; font-size: 12px;">
        <form role="form" action="<?php echo site_url('software/Add_New_Employee/store');?>" enctype="multipart/form-data" method="post" style="padding:10px; font-size: 12px;">
          <div class="row"> </div>
          <div class="row">
		  <div class="col-md-3"></div>
            <div class="col-md-6">
			  ...
			  <div class="form-group" style="padding-top:10px;">
				...
				<div class="form-group" style="padding-top:10px;">
                           <button type="submit" class="btn btn-success" name="submit">Save New Employee</button>
                        </div>
