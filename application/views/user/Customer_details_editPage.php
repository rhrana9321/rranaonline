  ...
  <div class="col-md-12" style="margin:15px 0px 15px 0px; padding:0px 15px 0px 0px;">
    ...
    <div class="col-md-10" style="background:#FFFFFF; border:1px solid #999999;">
      ...
      <div class="row" style="padding:10px; font-size: 12px;">
		...
		<input value="<?php echo $find_customer_info->custo_id; ?>" type="hidden"
                                   name="custo_id" class="form-control">
          <div class="row">
            ...
            <div class="col-md-10 col-md-offset-1">
              ...
              <div class="col-md-6">
                ...
                <label>Previus months due</label>
                 <input onKeyPress="return numbersOnly(event)" type="text" value="<?php echo $find_customer_info->previus_months_due; ?>" name="previus_months_due" class="form-control"
                  ...
                  <div class="col-md-6">
                    <div class="form-group">
                      ...
                      <div class="input-group">
                        <input type="number" name="previous_due_payment" class="form-control"  onkeypress="return numbersOnly(event)"
                ...
                <div class="form-group">
                  ...
                  <input type="text" name="connection_date" class="form-control"
                                   value="<?php echo $find_customer_info->con_date; ?>"
                                  >
                </div>
