    ...
    .pointer:hover{
      ...
      <div class="row">
        <div class="col-md-12 bg-teal-800" style="margin-top:20px; margin-bottom: 15px;">
          <div class="col-md-8">
            <h4><strong><span id="showDate">The Accounting Statement of May 2020</span></strong></h4>
          </div>
          <div class="col-md-2"> <a class="btn btn-success btn-sm pull-left" href="?q=daily_acc_statement" style="margin-top:3px;">Daily Accounting Statement</a> </div>
          <div class="col-md-2">
      ...
      <div class="row" style="padding:5px; font-size: 12px;">
        <div class="row" id="month_print">
          <div class="col-md-12">
            ...
            <table class="table table-responsive table-bordered table-striped" id="monthly_tbl" style="width:100%;">
              <thead>
                <tr>
                  <th class="col-md-1">Sl</th>
                  <th class="col-md-2">Date</th>
                  <th class="col-md-3 text-center">Particular</th>
			  ...
			  ?>
                <tr id="1" class="pointer">
                  <td><?php echo $i++; ?></td>
                  <td><?php echo $acc_value->c_date; ?></td>
                  <td class="text-right"><?php echo $acc_value->particular; ?></td>
                  <td class="text-center"><?php echo $clint_info->name; ?></td>
                  <td class="text-right"><?php echo $acc_value->credit; ?></td>
                  <td style="text-align: right;"><?php echo $acc_value->debit; ?></td>
              ...
              <tfoot>
                <tr style="font-size:14px;">
                  ...
                  <td class="text-right"><b><?php echo $total_cradit; ?></b></td>
                  <td class="text-right"><b><?php echo $total_debit; ?></b></td>
                  <td class="text-right"><b><?php echo $sum; ?></b></td>
                </tr>
