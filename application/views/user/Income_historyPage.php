...
<div class="container" id="content"
  ...
  <div class="col-md-12" style="margin:15px 0px 15px 0px; padding:0px 15px 0px 0px;">
    ...
    <div class="col-md-10" style="background:#FFFFFF; border:1px solid #999999;">
      ...
      <div class="row bg-slate-700">
        <div class="col-md-6">
          <h4 id="preview_date">View Others Income History Information of</h4>
        </div>
  ...
  <form role="form" enctype="multipart/form-data" action="<?php echo site_url('software/Others_Income/store');?>" method="post">    
        ...
        <div class="col-md-12">
            ...
            <div class="col-md-5">
              <div class="form-group">
                ...
                <div class="col-sm-8">
                  <input style="color: black;" id="to_date"
                               value="" type="date"
            ...
            <div class="col-md-2">
              <input type="submit" name="search" class="btn btn-primary submit" value="Search">
            </div>
