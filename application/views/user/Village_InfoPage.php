      ...
      <div class="modal fade" id="addZoneModal" role="dialog">
        <div class="modal-dialog">
          <div class="modal-content">
            ...
            <form method="post" action="<?php echo site_url('software/Village_Info/store');?>">
                ...
                <div class="row" style="padding:0 10px;">
                  ...
                  <div class="col-md-12">
                    <div class="form-group text-center">
                      <button type="submit" class="btn btn-default" name="zoneAddSubmit"> Insert Village </button>
                    </div>
                  </div>
                </div>
              </div>
