...
<div class="container" id="content"
    ...
    <div class="col-md-10" style="background:#FFFFFF; border:1px solid #999999;">
      ...
      <div class="row bg-slate-700">
		...
		<?php 
		  ...
		  ?>
          <h4 id="preview_date">View Expense Information of 01 <?php echo $monthName3; ?> <?php echo $year3; ?></h4>
        </div>
  ...
  <form role="form" enctype="multipart/form-data" id="loadingId" action="<?php echo site_url('software/Expense/store');?>" method="post">    
    <div class="modal-content">
      ...
      <div class="row bg-slate-700" style="padding:3px;">
        <div class="col-md-12">
        <form action="<?php echo site_url("software/Expense/expencesin_wise_print");?>" method="post">
            <div class="col-md-5">
                <div class="form-group">
            ...
            <div class="col-md-2">
              <input type="button" name="search" class="btn btn-primary submit" value="Search">
            </div>
      ...
      <div class="row" style="padding:10px; font-size: 12px;">
        <div class="col-md-12">
		 <div style="padding-bottom:5px;"> <button type="submit" class="btn btn-primary pull-right">Print Expense</button></div>
		  </form>
