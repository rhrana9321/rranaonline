    ...
    <div class="col-md-10" style="background:#FFFFFF; border:1px solid #999999;">
      <div class="row" style="padding: 6px;">
        <div class="col-md-12 bg-grey-600 padding_10_px">
          <div class="col-md-6">
            <h4>View Out Item info</h4>
          </div>
          <div class="col-md-6" style="">
            <button type="button" class="btn btn-default pull-right" data-toggle="modal"
                        data-target="#addZoneModal"> <span class="glyphicon glyphicon-plus"></span> Out Item </button>
          </div>
        </div>
      </div>
	  
	  <div id="select_date" class="col-md-12 bg-teal-800" style="margin-bottom: 20px;padding:5px 0px">
	   <form action="<?php echo site_url("software/Item_Manage/item_out_print");?>" method="post">
            <div class="col-md-1">
              ...
              <table style="margin-left:-15px;" class="table table-bordered table-hover table-striped" id="datatable">
                ...
                <tr>
				  ...
				  <td class="text-center"><?php echo ($v->price*$v->store); ?></td>
				   <td class="text-center"><a  href="<?php echo site_url('software/Item_Manage/Item_out_edit/' .$v->id);?>">Edit </a>	</td>
                </tr>
              <?php } ?>  
                <tfoot>
                <tr>
        ...
        <div class="modal-dialog">
          <div class="modal-content">
            <div class="modal-header">
              ...
              <h4 class="modal-title text-center">Out Item</h4>
            </div>
            <form method="post" id="loadingId" action="<?php echo site_url('software/Item_Manage/out_store');?>">
                ...
                <div class="row" style="padding:0 10px;">
                  ...
                  <div class="col-md-12">
                    <div class="form-group text-center">
                       <button type="submit" data-loading-text="<i class='fa fa-spinner fa-spin'></i>Processing..." class="abcd btn btn-primary"><span> Item Out</span></button>
                    </div>
                  </div>
                </div>
              </div>
...
<script>
	...
	var urlmgs = "<?php echo site_url('software/Item_Manage/storeOutOutshowreport'); ?>";
	$.ajax({
		url:urlmgs,
		type:"POST",
