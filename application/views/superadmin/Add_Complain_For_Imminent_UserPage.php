...
style=" margin-top:5px; margin-bottom: 5px; font-size:14px;  color:red; font-weight:bold; text-align: center;"> <b></b> </div>
      <div class="row">
        ...
        <form role="form" id="loadingId" enctype="multipart/form-data" action="<?php echo site_url('software/Add_Complain_For_Imminent_User/store');?>" method="post">
          <div class="col-md-6 col-md-offset-3">
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group">
                        <label> Complain Date</label>
                        <input type="text" name="complain_date" class="form-control" autocomplete="off" required>
                    </div>
                </div>
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="text" value="<?php echo date("h:i:sa"); ?>" name="complain_time" class="form-control" autocomplete="off">
                    </div>
                </div>
            </div>
				<div class="form-group">
              <label>Customer Name</label>
             <input type="text" name="customer_name" class="form-control" autocomplete="off" placeholder="Name" required>
            </div>
			
			<div class="form-group">
              <label>Customer Address</label>
             <input type="text" name="customer_address" class="form-control" autocomplete="off" placeholder="Address" required>
            </div>
			<div class="form-group">
              <label>Customer Cell No.</label>
            <input type="text" name="customer_mobile" class="form-control" autocomplete="off" placeholder="Ex: 01XXXXXXXXX"/>
            </div>
