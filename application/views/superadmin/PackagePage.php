        ...
        <div class="col-md-12 bg-grey-600 padding_10_px">
          ...
          <div class="col-md-6" style="">
            <button type="button" class="btn btn-default pull-right" data-toggle="modal"
                        data-target="#addZoneModal"> <span class="glyphicon glyphicon-plus"></span> Add Package </button>
          </div>
        </div>
      </div>
      <div class="row">
              ...
              <table style="margin-left:-15px;" class="table table-bordered table-hover table-striped" id="datatable">
                ...
                <tr>
                  ...
                  <td class="text-center"><?php echo $v->name; ?></td>
				   <td class="text-center"><?php echo $v->Speed; ?></td>
				    <td class="text-center"><?php echo $v->amount; ?></td>
                  <td class="text-center"><div class="btn-group"> 
				 <a class="btn btn-xs btn-info" style="padding:5px;"
                                           href="<?php echo site_url('software/Package/edit/' .$v->id);?>"> <span class="glyphicon glyphicon-edit"></span> </a> </div></td>
                </tr>
              <?php } ?>  
      ...
      <div class="modal fade" id="addZoneModal" role="dialog">
        <div class="modal-dialog">
          <div class="modal-content">
            ...
            <form method="post"  id="loadingId" action="<?php echo site_url('software/Package/store');?>">
                  ...
                  <div class="col-md-12">
                    <div class="form-group">
                      <div class="row">
                        ...
                        <input type="text" name="name" class="form-control" id="ResponsiveTitle" placeholder="Provide Package Name">
                      </div>
                    </div>
					<div class="form-group">
                      <div class="row">
					...
					<div class="form-group">
                      <div class="row">
                        <label>Speed</label>
                        <input type="text" name="Speed" class="form-control" id="ResponsiveTitle" placeholder="Provide Speed">
                      </div>
                    </div>
					...
					<div class="form-group">
                      <div class="row">
                        ...
                        <input type="text" name="amount" class="form-control" id="ResponsiveTitle" placeholder="Provide Bill amount">
                      </div>
                    </div>
                  </div>
                  <div class="col-md-12">
                    <div class="form-group text-center">
                      <button type="submit" data-loading-text="<i class='fa fa-spinner fa-spin'></i>Processing..." class="abc left1_btn left1_btn-1 left1_btn-1c"><span>Insert Package</span></button>
                    </div>
                  </div>
                </div>
              </div>
