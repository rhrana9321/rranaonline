    ...
    <div class="col-md-10" style="background:#FFFFFF; border:1px solid #999999;">
      <div class="row">
        <div class="col-md-12 bg-teal-800">
          <h4>Occasional SMS Details</small></h4>
        </div>
      </div>
      <div class="col-md-12"
     style=" margin-top:5px; margin-bottom: 5px; font-size:14px;  color:red; font-weight:bold; text-align: center;"> <b></b> </div>
      <div class="row">
        <form role="form" enctype="multipart/form-data" action="<?php echo site_url('software/Add_Custome_SMS/Occasional_action');?>" method="post">
          <div class="col-md-6 col-md-offset-3">
            <div class="form-group">
              <label>Occasional Custome SMS Details</label>
        ...
        <form role="form" enctype="multipart/form-data" action="<?php echo site_url('software/Add_Custome_SMS/Occasional_sms_action');?>" method="post">
          <div class="row">
            <div class="col-md-10 col-md-offset-1">
              <input type="hidden" name="comments" value="<?php echo $add_customer_sms_tableList->sms_details; ?>"/>
			  <div class="col-md-2"></div>
              <div class="col-md-6" style="padding-left:50px;">
                <div class="form-group">
                   <select class="form-control" name="zone" id="zone">
				   <option value="" selected="selected">All Zones Client</option>
