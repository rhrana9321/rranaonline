        ...
        <div class="col-md-12 bg-grey-600 padding_10_px">
          ...
          <div class="col-md-6" style="">
            <button type="button" class="btn btn-default pull-right" data-toggle="modal"
                        data-target="#addZoneModal"> <span class="glyphicon glyphicon-plus"></span> Add Remarks </button>
          </div>
        </div>
      </div>
      <div class="row">
              ...
              <table style="margin-left:-15px;" class="table table-bordered table-hover table-striped" id="datatable">
                <thead>
                  <tr>
					...
					<th class="text-center">Creatred at</th>
                    <th class="text-center">Action</th>
                  </tr>
                </thead>
				<?php $i = 1; foreach ($remarks_List as $v) { ?> 
                <tr>
                  <td class="text-center"><?php echo $i++; ?></td>
                  <td class="text-center"><?php echo $v->comments; ?></td>
				  <td class="text-center"><?php echo $v->cdate_time; ?></td>
                  <td class="text-center"><div class="btn-group"> 
				 <a class="btn btn-xs btn-info" style="padding:5px;"
                                           href="<?php echo site_url('software/Customer_info/remarks_edit/' .$v->remarks_id );?>"> <span class="glyphicon glyphicon-edit"></span> </a> <a href="<?php echo site_url('software/Customer_info/remarks_delete/' .$v->remarks_id);?>"
        ...
        <div class="modal-dialog">
          <div class="modal-content">
            <div class="modal-header">
              ...
              <h4 class="modal-title text-center">Insert New Remarks</h4>
            </div>
            <form method="post" action="<?php echo site_url('software/Customer_info/remarks_store');?>">
                ...
                <div class="row" style="padding:0 10px;">
                  <div class="col-md-12">
                    <div class="form-group">
                      <div class="row">
                        <label>Remarks</label>
						 <input type="hidden" name="customer_id" class="form-control" id="customer_id" value="<?php echo $custo_id; ?>" placeholder="Provide Zone Name">
                        <input type="text" name="comments" class="form-control" id="comments" placeholder="Remarks">
                      </div>
                    </div>
                  </div>
                  <div class="col-md-12">
                    <div class="form-group text-center">
                      <button type="submit" class="btn btn-default" name="zoneAddSubmit"> Insert Remarks </button>
                    </div>
                  </div>
                </div>
              </div>
