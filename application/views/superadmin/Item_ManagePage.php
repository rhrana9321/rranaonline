              ...
              <table style="margin-left:-15px;" class="table table-bordered table-hover table-striped" id="datatable">
                ...
                <tr>
				 ...
				 <a class="btn btn-xs btn-info" style="padding:5px;"
                                           href="<?php echo site_url('software/Item_Manage/edit/' .$v->id);?>"> <span class="glyphicon glyphicon-edit"></span> </a>  </div></td>
                </tr>
              <?php } ?>  
        ...
        <div class="modal-dialog">
          <div class="modal-content">
            <div class="modal-header">
              ...
              <h4 class="modal-title text-center">Insert New Item</h4>
            </div>
            <form method="post" id="loadingId" action="<?php echo site_url('software/Item_Manage/store');?>">
                ...
                <div class="row" style="padding:0 10px;">
				  ...
				  <div class="form-group">
                    ...
                    <div class="form-group">
                      <div class="row">
                        ...
                        <input type="text" name="Brand" class="form-control" id="ResponsiveTitle" placeholder=" Item Brand">
                      </div>
                    </div>
					...
					<div class="form-group">
                      <div class="row">
                        ...
                        <input type="text" name="name" class="form-control" id="ResponsiveTitle" placeholder=" Item Name">
                      </div>
                    </div>
                  ...
                  <div class="col-md-12">
                    <div class="form-group text-center">
                     <button type="submit" data-loading-text="<i class='fa fa-spinner fa-spin'></i>Processing..." class="abcd btn btn-primary"><span> Item Add</span></button>
                    </div>
                  </div>
                </div>
              </div>
