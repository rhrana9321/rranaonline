...
<div class="container" id="content"style="width:100% !important; padding:0px; border:0px; background-color:#EAEAEA;">
  ...
  <div class="col-md-12" style="margin:15px 0px 15px 0px; padding:0px 15px 0px 0px;">
    ...
    <div class=" panel-body col-md-12 bg-teal-800 text-center" style="margin-bottom:5px;">
        <h4>Automated Employee Id : EMPL<?php echo $maxmeberid->employee_id+1; ?></h4 >
    </div>
</div>
      <div class="row" style="padding:10px; font-size: 12px;">
        <form id="loadingId" action="<?php echo site_url('software/Add_New_Employee/store');?>" enctype="multipart/form-data" method="post" style="padding:10px; font-size: 12px;">
          <div class="row"> </div>
          <div class="row">
		  <div class="col-md-3"></div>
            <div class="col-md-6">
			  ...
			  <div class="form-group" style="padding-top:10px;">
				...
				<div class="form-group" style="padding-top:10px;">
						   <button type="submit" data-loading-text="<i class='fa fa-spinner fa-spin'></i>Processing..." class="abcd btn btn-success"><span> Save New Employee</span></button>
                        </div>
