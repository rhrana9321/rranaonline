    ...
    .pointer:hover {
      ...
      <div class="col-md-12 bg-grey-800" style="margin-top:20px; margin-bottom: 15px;">
        <div class="col-md-6">
          ...
          <h4><strong>The Monthly Statement of <?php echo $monthName3; ?> <?php echo $year3; ?></strong></h4>
        </div>
	   ...
	   <div class="progress prgbar" style="display:none;">
        ...
        <div class="col-md-12" style="font-size:12px;">
          ...
          <table class="table table-responsive table-bordered table-hover table-striped" id="monthlyTable">
			...
			$total_opannig			= $total_opannig + $mon_value->total_opaning_balance;
			 ?>
			  <tr class="digitData">
				...
				<?php } else { ?>
				<td class="text-center bill pointer" data-day="2020-05-12"><a style="cursor:pointer;" data_date="<?php echo $mon_value->month_running_date; ?>" class="class_date"><?php echo $mon_value->dat_total_bill_collection; ?></a></td>
				<?php } ?>
				 
				<?php if($mon_value->day_total_connection_charge == 0){ ?>
                <td class=" text-center con"data-day="0">--</td>
				<?php } else { ?>
				<td class=" text-center con"data-day="0"><a style="cursor:pointer;" data_date="<?php echo $mon_value->month_running_date; ?>" class="Conn_class_date"><?php echo $mon_value->day_total_connection_charge; ?></a></td>
				<?php } ?>
				
				<?php if($mon_value->day_total_others_income == 0){ ?>
                <td class="text-center other "data-day="0">--</td>
				<?php } else { ?>
				<td class="text-center other "data-day="0"><a style="cursor:pointer;" data_date="<?php echo $mon_value->month_running_date; ?>" class="Others_class_date"><?php echo $mon_value->day_total_others_income; ?></a></td>
				<?php } ?>
				
				<?php if($mon_value->total_opaning_amount == 0){ ?>
                <td class=" text-center other">--</td>
				<?php } else { ?>
				<td class=" text-center other"><a style="cursor:pointer;" data_date="<?php echo $mon_value->month_running_date; ?>" class="Opp_class_date"><?php echo $mon_value->total_opaning_amount; ?></a></td>
				<?php } ?>
				<?php if($mon_value->day_total_expence == 0){ ?>
                <td class="text-center expense "data-day="0">--</td>
				<?php } else { ?>
				 <td class="text-center expense "data-day="0"><a style="cursor:pointer;" data_date="<?php echo $mon_value->month_running_date; ?>" class="Expence_class_date"><?php echo $mon_value->day_total_expence; ?></a></td>
				<?php } ?>
          ...
          <div>
            <table class="table">
              <tr>
                ...
                <th style="text-align: right;"><?php echo $total_opannig_ble = $total_opannig; ?> Taka </th>
              </tr>
              <tr>
        ...
        <div class="col-md-12 bg-danger">
          ...
          <h6 class="pull-right text-center" style="border-top:2px solid black;width:40%">Authorized Signature<h6>
        </div>
      </div>
      <script>
...
<script>
	...
	var urlmgs = "<?php echo site_url('software/Monthly_Balance_Report/Bill_record_report'); ?>";
	$.ajax({
		url:urlmgs,
		type:"POST",
 ...
 $(".Conn_class_date").on('click', function(){
	var data_date = $(this).attr("data_date")
	var urlmgs = "<?php echo site_url('software/Monthly_Balance_Report/Conn_charge_record_report'); ?>";
	$.ajax({
		url:urlmgs,
		type:"POST",
		data:{data_date:data_date},
 ...
 $(".Opp_class_date").on('click', function(){
	var data_date = $(this).attr("data_date")
	var urlmgs = "<?php echo site_url('software/Monthly_Balance_Report/Opp_charge_record_report'); ?>";
	$.ajax({
		url:urlmgs,
		type:"POST",
		data:{data_date:data_date},
...
$(".Others_class_date").on('click', function(){
	var data_date = $(this).attr("data_date")
	var urlmgs = "<?php echo site_url('software/Monthly_Balance_Report/Others_charge_record_report'); ?>";
	$.ajax({
		url:urlmgs,
		type:"POST",
		data:{data_date:data_date},
...
$(".Expence_class_date").on('click', function(){
	var data_date = $(this).attr("data_date")
	var urlmgs = "<?php echo site_url('software/Monthly_Balance_Report/Expence_charge_record_report'); ?>";
	$.ajax({
		url:urlmgs,
		type:"POST",
		data:{data_date:data_date},
