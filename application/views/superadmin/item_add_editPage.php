    ...
    <div class="col-md-10" style="background:#FFFFFF; border:1px solid #999999;">
      <div class="row" style="padding:10px; font-size: 12px;">
        ...
        <div class="col-md-6 col-md-offset-3">
           ...
           <form method="post" action="<?php echo site_url('software/Zone_Info/updated');?>">
		    <input type="hidden" name="id" value="<?php echo $item_add_List->id; ?>" class="form-control" id="ResponsiveTitle" placeholder="Provide zone Name">
             <div class="form-group">
                      ...
                      <div class="row">
                        <label>Item Name</label>
						 <div id="pro_sub_idfsf">
						  ...
						  <option value="<?php echo $item_add_List->id; ?>"><?php echo $item_add_List->name; ?></option>
						</select>
					</div>
                      </div>
                    </div>
					...
					<div class="form-group">
                      <div class="row">
                        <label>Qty</label>
                        <input type="text" name="store" value="<?php echo $item_add_List->store; ?>" class="form-control" id="ResponsiveTitle" placeholder="Qty">
                      </div>
                    </div>
					...
					<div class="form-group">
                      <div class="row">
                        ...
                        <input type="text" name="price" value="<?php echo $item_add_List->price; ?>" class="form-control" id="ResponsiveTitle" placeholder="Price">
                      </div>
                    </div>
					<div class="form-group">
                      <div class="row">
                        <label>Note</label>
                        <input type="text" name="note" value="<?php echo $item_add_List->note; ?>" class="form-control" id="ResponsiveTitle" placeholder="note">
                      </div>
                    </div>
            <div class="row">
