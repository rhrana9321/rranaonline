    ...
    <div class="col-md-10" style="background:#FFFFFF; border:1px solid #999999;">
      <div class="row" style="padding: 6px;">
        <div class="col-md-12 bg-grey-600 padding_10_px">
          <div class="col-md-6">
            <h4>View Village info</h4>
          </div>
          <div class="col-md-6" style="">
            <button type="button" class="btn btn-default pull-right" data-toggle="modal"
                        data-target="#addZoneModal"> <span class="glyphicon glyphicon-plus"></span> Add Village </button>
          </div>
        </div>
      </div>
      <div class="row">
              ...
              <table style="margin-left:-15px;" class="table table-bordered table-hover table-striped" id="datatable">
                ...
                <tr>
				 ...
				 <a class="btn btn-xs btn-info" style="padding:5px;"
                                           href="<?php echo site_url('software/Village_Info/edit/' .$v->id);?>"> <span class="glyphicon glyphicon-edit"></span> </a> <a href="<?php echo site_url('software/Village_Info/delete/' .$v->id);?>"
        ...
        <div class="modal-dialog">
          <div class="modal-content">
            <div class="modal-header">
              ...
              <h4 class="modal-title text-center">Insert New Village</h4>
            </div>
            <form method="post" id="loadingId" action="<?php echo site_url('software/Village_Info/store');?>">
                  ...
                  <div class="col-md-12">
                    <div class="form-group">
                      <div class="row">
                        ...
                        <input type="text" name="name" class="form-control" id="ResponsiveTitle" placeholder="Provide village Name">
                      </div>
                    </div>
                  </div>
                  <div class="col-md-12">
                    <div class="form-group text-center">
					<button type="submit" data-loading-text="<i class='fa fa-spinner fa-spin'></i>Processing..." class="abc left1_btn left1_btn-1 left1_btn-1c"><span>Insert Village</span></button>
                    </div>
                  </div>
                </div>
              </div>
