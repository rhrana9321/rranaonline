...
style=" margin-top:5px; margin-bottom: 5px; font-size:14px;  color:red; font-weight:bold; text-align: center;"> <b></b> </div>
      <div class="row">
        ...
        <form role="form" enctype="multipart/form-data" action="<?php echo site_url('software/Add_Complain/store');?>" method="post">
		
		<input type="hidden"  name="id" value="<?php echo $add_complain_tableList->id; ?>">
          ...
          <div class="col-md-6 col-md-offset-3">
            <div class="form-group">
              ...
              <select name="customer_id" id="customer_id" class="form-control select2" required>
                ...
                <option <?php echo ($add_complain_tableList->customer_id ==  $cv->name) ? ' selected="selected"' : '';?> value="<?php echo $cv->name; ?>"><?php echo $cv->name; ?> (CUS<?php echo $cv->customer_id_create; ?>)</option>
				<?php } ?>
            ...
            <div class="form-group">
              <div class="checkbox">
                <label>
                <input type="checkbox" name="sms_check" <?php echo ($add_complain_tableList->sms_check ==  '1') ? ' checked="checked"' : '';?> value="<?php echo $add_complain_tableList->sms_check; ?>">
