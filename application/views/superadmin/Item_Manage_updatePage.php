    ...
    <div class="col-md-10" style="background:#FFFFFF; border:1px solid #999999;">
      <div class="row" style="padding:10px; font-size: 12px;">
        ...
        <div class="col-md-6 col-md-offset-3">
           ...
           <form method="post" action="<?php echo site_url('software/Item_Manage/Item_Manage_up_action');?>">
		    <input type="hidden" name="id" value="<?php echo $item_add_table_List->id; ?>" class="form-control" id="ResponsiveTitle" placeholder="Provide zone Name">
            <div class="form-group row">
              <div class="text-center">
                <h5 class="col-md-4">Note :</h5>
                <div class="col-md-8">
                  <input type="text" name="note"
                               value="<?php echo $item_add_table_List->note; ?>"
                               class="form-control" id="ResponsiveTitle" placeholder="note">
                </div>
              </div>
            </div>
            <div class="row">
              <div class="text-center">
                <button type="submit" class="btn btn-primary" name="update"> Update zone Info </button>
              </div>
            </div>
          </form>
        </div>
