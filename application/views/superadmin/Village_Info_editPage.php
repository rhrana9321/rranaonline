    ...
    <div class="col-md-10" style="background:#FFFFFF; border:1px solid #999999;">
      <div class="row" style="padding:10px; font-size: 12px;">
        ...
        <div class="col-md-6 col-md-offset-3">
           ...
           <form method="post" action="<?php echo site_url('software/Village_Info/updated');?>">
		    <input type="hidden" name="id" value="<?php echo $find_zone_info->id; ?>" class="form-control" id="ResponsiveTitle" placeholder="Provide village Name">
            <div class="form-group row">
              <div class="text-center">
                <h5 class="col-md-4">Village Name :</h5>
                <div class="col-md-8">
                  <input type="text" name="name"
                               value="<?php echo $find_zone_info->name; ?>"
                               class="form-control" id="ResponsiveTitle" placeholder="Provide Village Name">
                </div>
              </div>
            </div>
            <div class="row">
              <div class="text-center">
                <button type="submit" class="btn btn-primary" name="update"> Update Village Info </button>
              </div>
            </div>
          </form>
        </div>
