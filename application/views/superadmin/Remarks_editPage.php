    ...
    <div class="col-md-10" style="background:#FFFFFF; border:1px solid #999999;">
      <div class="row" style="padding:10px; font-size: 12px;">
        ...
        <div class="col-md-6 col-md-offset-3">
           ...
           <form method="post" action="<?php echo site_url('software/Customer_info/remarks_update_now');?>">
		    <input type="hidden" name="remarks_id" value="<?php echo $find_remarks_info->remarks_id ; ?>" class="form-control" id="ResponsiveTitle" placeholder="Provide zone Name">
            <div class="form-group row">
              <div class="text-center">
                <h5 class="col-md-4">Remarks :</h5>
                <div class="col-md-8">
                  <input type="text" name="comments"
                               value="<?php echo $find_remarks_info->comments; ?>"
                               class="form-control" id="ResponsiveTitle" placeholder="comments">
                </div>
              </div>
            </div>
            <div class="row">
              <div class="text-center">
                <button type="submit" class="btn btn-primary" name="update"> Update Remarks </button>
              </div>
            </div>
          </form>
        </div>
