...
<table style="" class="table  table-hover table-striped" id="datatable">
				...
				<th colspan="2" style="background:#FFFFFF; color:#000000; text-align:center; font-size:13px; border-left:#FFFFFF 1px solid;" class="col-md-1">In Item &nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</th>
              ...
              <?php } ?> 
			   <tfoot>
                <tr>
				  <td colspan="6" style="border:#dddddd 1px solid;"  class="text-right">Total =</td>
				  <td class="text-center" style="border:#dddddd 1px solid;" ><?php echo $total_item; ?></td>
                </tr> 
                 </tfoot>
              </table>
