    ...
    <div class="col-md-10" style="background:#FFFFFF; border:1px solid #999999;">
      <div class="row" style="padding:10px; font-size: 12px;">
        ...
        <div class="col-md-6 col-md-offset-3">
           <form method="post" action="<?php echo site_url('software/Item_Manage/updated');?>">
		    <input type="hidden" name="id" value="<?php echo $find_zone_info->id; ?>" class="form-control" id="ResponsiveTitle" placeholder="Provide Item Name">
            <div class="form-group row">
              <div class="text-center">
                <h5 class="col-md-4">Item Name :</h5>
                <div class="col-md-8">
                  <input type="text" name="name" value="<?php echo $find_zone_info->name; ?>" class="form-control" id="ResponsiveTitle" placeholder="Item Name">
                </div>
              </div>
            </div>
			<div class="form-group row">
              <div class="text-center">
                <h5 class="col-md-4">Item Brand :</h5>
                <div class="col-md-8">
                  <input type="text" name="Brand" value="<?php echo $find_zone_info->Brand; ?>" class="form-control" id="ResponsiveTitle" placeholder="Item Brand">
                </div>
              </div>
            </div>
			<div class="form-group row">
              <div class="text-center">
                <h5 class="col-md-4">Item Type :</h5>
                <div class="col-md-8">
                 <select class="form-control" style="width:100%; text-align:left;" name="type" id="type">
            ...
            <div class="row">
              <div class="text-center">
                <button type="submit" class="btn btn-primary" name="update"> Update Item Info </button>
              </div>
            </div>
          </form>
        </div>
