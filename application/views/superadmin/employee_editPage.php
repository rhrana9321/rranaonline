		  ...
		  <div class="col-md-3"></div>
            <div class="col-md-6">
              ...
              <div class="form-group">
                ...
                <input onKeyPress="return numbersOnly(event)" type="text" value="<?php echo $employeeList->mobile; ?>"  name="mobile" class="form-control">
              </div>
              <div class="form-group">
              ...
              <div class="form-group">
                ...
                <textarea class="form-control" name="details" id="ResponsiveDetelis" rows="4"><?php echo $employeeList->details; ?></textarea>
              </div>
