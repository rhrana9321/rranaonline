...
<div id="body_service_list">
            <div id="body_service_list_text">
              <ul class="box" style="margin:0px ! important;">
                ...
                <li class="mactive" style="background: url('<?php echo base_url('resource/assets/left-menu-active.gif');?>') repeat-x scroll 0 0 rgba(0, 0, 0, 0);"> <a href="?q=view_agent" class="left_menu_bull"
                  ...
                  <ul>
                    ...
                    <li class="list">&nbsp;<a class="texta" href="<?php echo site_url('software/Zone_Info');?>">Zone Info</a></li>
					 ...
					 <li class="list">&nbsp;<a class="texta" href="<?php echo site_url('software/Package');?>">Package View</a></li>
               ...
               <li class="menu" style="background: url('<?php echo base_url('resource/assets/left-menu-active.gif');?>') repeat-x scroll 0 0 rgba(0, 0, 0, 0);"> <a href="<?php echo site_url('software/Data_backup/submit_data'); ?>" class="left_menu_bull mainli" style="color:white;"> Database Download </a> </li>
              </ul>
            </div>
          </div>