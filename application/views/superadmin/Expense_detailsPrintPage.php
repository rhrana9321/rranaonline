...
<table class="table table-hover table-striped" id="example4">
			...
			<tr>
				...
				<th colspan="2" style="background:#FFFFFF; color:#000000; text-align:center; font-size:13px; border-left:#FFFFFF 1px solid;" class="col-md-1"> Expense History &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;  </th>
              ...
              <tr>
                ...
                <th style="border:#dddddd 1px solid;">Date</th>
                <th style="border:#dddddd 1px solid;">Description</th>
                <th style="border:#dddddd 1px solid;" class="text-center">Amount</th>
              </tr>
            </thead>
			<?php $i=1; 
			   $total_amount = 0; 
            ...
            <tr>
              ...
              <td style="border:#dddddd 1px solid;"><?php echo $v->cdate; ?></td>
              <td style="border:#dddddd 1px solid;"><?php echo $v->details; ?></td>
              <td style="border:#dddddd 1px solid;" class="text-right"><?php echo $v->amount; ?></td>
            ...
            <tr style='height:33px;'>
              <th style="border:#dddddd 1px solid;" colspan="3" class="text-right"><b>Total Expense</b></th>
              <th style="border:#dddddd 1px solid;" class="text-right"><?php echo $total_amount; ?></th>
            </tr>
          </table>
