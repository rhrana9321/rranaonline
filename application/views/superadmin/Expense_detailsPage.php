    ...
    function printDiv(divName) {
      ...
      <div class="row">
        <div class="col-md-12 bg-slate-800" style="margin-top:20px; margin-bottom: 15px;"> <a class="btn btn-primary btn-sm pull-left" href="?q=expense_report" style="margin-top:3px;"><span
          ...
          <h4 class="text-center"> <span id="printTitle">All Expense Information of <?php echo $infoList->name; ?></span>
		  <form method="post" enctype="multipart/form-data" action="<?php echo site_url('software/Expense_Report/Expense_ReportPrint');?>"/>
		    <input  type="hidden" value="<?php echo $header_name; ?>" name="id_header_name" style="color:#000000;">
            <button type="submit" class="btn btn-success btn-sm pull-right" style="margin-top: -25px ;">Print Statement </button>
			</form>
