...
<div class="container" id="content"
  ...
  <div class="col-md-12" style="margin:15px 0px 15px 0px; padding:0px 15px 0px 0px;">
    ...
    <div class="col-md-10" style="background:#FFFFFF; border:1px solid #999999;">
      ...
      <div class="row bg-slate-700">
        <div class="col-md-6">
          <h4 id="preview_date">View Others Income History Information of <?php echo $infoList->name; ?></h4>
        </div>
  ...
  <form role="form" enctype="multipart/form-data" id="loadingId" action="<?php echo site_url('software/Others_Income/store');?>" method="post">    
    <div class="modal-content">
      ...
      <div class="modal-body">
       <div class="form-group">
					...
					<select class="form-control" required="required" name="header_name" id="header_name">
						...
						<option value="<?php echo $av->name; ?>"><?php echo $av->name; ?></option>
						<?php } ?>
					</select>
                       </div>
      ...
      <div class="modal-footer">
       ...
       <button style="background:#667eea; color:#FFFFFF; padding:5px; border:3px #667eea solid; -webkit-box-shadow: -2px 2px 20px -8px rgba(0,0,0,0.75);
-moz-box-shadow: -2px 2px 20px -8px rgba(0,0,0,0.75); box-shadow: -2px 2px 20px -8px rgba(0,0,0,0.75); border-radius: 5px;" type="submit" data-loading-text="<i class='fa fa-spinner fa-spin'></i>Processing..." class="abcd left1_btn left1_btn-1 left1_btn-1c abcname"><span>Create  >></span></button>
      </div>
    </div>
	</form>
  </div>
      ...
      <div class="row" style="padding:10px; font-size: 12px;">
        <div class="col-md-12">
		 <form action="<?php echo site_url("software/Others_Income/othersin_print");?>" method="post">
		 <input type="hidden" value="<?php echo $header_name; ?>" name="header_name">
		<div style="padding-bottom:5px;"> <button type="submit" class="btn btn-primary pull-right">Print Others Income</button></div>
		</form>
          <div class="table-responsive list_valu_html">
      ...
      <div class="modal-footer">
        ...
        <button type="submit" class="btn btn-primary">Update</button>
              ...
              <tfoot>
                <tr>
                  <th colspan="3" style="text-align:right;"> Others Income</th>
