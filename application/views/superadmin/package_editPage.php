    ...
    <div class="col-md-10" style="background:#FFFFFF; border:1px solid #999999;">
      <div class="row" style="padding:10px; font-size: 12px;">
        <div class="col-md-12" style="margin-bottom:30px;">
          <div class="bg-teal text-center" style="padding:5px;">
            <h4>Edit Package</h4>
          </div>
        </div>
        <div class="col-md-6 col-md-offset-3">
          
           <form method="post" action="<?php echo site_url('software/Package/updated');?>">
		    <input type="hidden" name="id" value="<?php echo $find_zone_info->id; ?>" class="form-control" id="ResponsiveTitle" placeholder="Provide zone Name">
            <div class="form-group row">
              <div class="text-center">
                <h5 class="col-md-4">Package Name :</h5>
                <div class="col-md-8">
                  <input type="text" name="name"
                               value="<?php echo $find_zone_info->name; ?>"
                               class="form-control" id="ResponsiveTitle" placeholder="Provide Package Name">
                </div>
              </div>
            </div>
			...
			<div class="form-group row">
              <div class="text-center">
                <h5 class="col-md-4">Speed :</h5>
                <div class="col-md-8">
                  <input type="text" name="Speed"
                               value="<?php echo $find_zone_info->direct_value; ?>"
                               class="form-control" id="ResponsiveTitle" placeholder="Provide Speed">
                </div>
              </div>
            </div>
			<div class="form-group row">
              <div class="text-center">
                <h5 class="col-md-4">Select Type :</h5>
                <div class="col-md-8">
                  <select class="form-control" id="status" name="status" required>
							<option value="">Select Type</option>
							<option <?php if($find_zone_info->status == 'KBps') echo"selected"; ?> value="KBps">KBps</option>
							<option <?php if($find_zone_info->status == 'MBps') echo"selected"; ?> value="MBps">MBps</option>
						  </select>
                </div>
              </div>
            </div>
			...
			<div class="form-group row">
              <div class="text-center">
                <h5 class="col-md-4">Bill amount :</h5>
                <div class="col-md-8">
                  <input type="text" name="amount"
                               value="<?php echo $find_zone_info->amount; ?>"
                               class="form-control" id="ResponsiveTitle" placeholder="Provide Bill amount">
                </div>
              </div>
            </div>
            <div class="row">
              <div class="text-center">
                <button type="submit" class="btn btn-primary" name="update"> Update Package Info </button>
              </div>
            </div>
          </form>
        </div>
