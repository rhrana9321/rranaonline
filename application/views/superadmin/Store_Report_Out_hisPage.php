  ...
  <div class="col-md-12" style="margin:15px 0px 15px 0px; padding:0px 15px 0px 0px;">
    ...
    .pointer:hover{
	  ...
	  <div class="col-md-12 bg-teal-800" style="margin-top:20px; margin-bottom: 15px;">
          <div class="col-md-8">
            <h4><strong><span id="showDate">Total <?php echo $itemnameList->name; ?> Out Report</span></strong></h4>
          </div>
        ...
        <div id="select_date" class="col-md-12 bg-teal-800" style="margin-bottom: 20px;padding:5px 0px">
            ...
            <div class="col-md-4">
              <input class="form-control" value="" type="text"
                       placeholder="Select Date" name="dateform" autocomplete="off"   id="dateform" required="required">
            </div>
            <div class="col-md-1">
              <label class="control-label pull-right" style="padding-top:5px" for="dateMonth">To : </label>
            </div>
            <div class="col-md-4">
              <input class="form-control" required="required" value="" autocomplete="off"  type="text"
...
<input class="form-control" required="required" value="<?php echo $itemnameList->id; ?>" autocomplete="off"  type="hidden" name="id" id="id" placeholder="Select Date">
            ...
            <div class="col-md-2 text-center">
              <input type="submit" class="btn btn-success viewAll" name="searchSubmit" value="Search">
            </div>
          </div>
...
<script>
	...
	var urlmgs = "<?php echo site_url('software/Item_Manage/storeOutshowreport'); ?>";
	$.ajax({
		url:urlmgs,
		type:"POST",
