  ...
  color: red;
     ...
     style=" margin-top:5px; margin-bottom: 5px; font-size:14px;  color:red; font-weight:bold; text-align: center;">
      ...
      <div class="row" id="month_print">
        ...
        <thead>
		<th colspan="3" style="background:#FFFFFF; color:#000000; text-align:left; font-size:16px;" class="col-md-1"><img title="Visit Site" alt="Our logo" src="<?php echo base_url('upload/' .$superdetails->logo_image);?>" width="100" height="45"></th>
				<th colspan="3" style="background:#FFFFFF; color:#000000; text-align:center; font-size:13px; border-left:#FFFFFF 1px solid;" class="col-md-1">&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;  &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;  View Customer Bill</th>
				<th colspan="5" style="background:#FFFFFF; color:#000000; text-align:right; font-size:11px; border-left:#FFFFFF 1px solid; width:10%;" class="col-md-1"><?php echo $superdetails->companyname; ?><br/><?php echo $superdetails->address; ?></th>
            <tr>
                <th style="background:#444444; color:#FFFFFF; font-size:10px; border:#dddddd 1px solid;" >Clint</th>
                <th style="background:#444444; color:#FFFFFF;font-size:10px; border:#dddddd 1px solid;" >Customer ID</th>
                <th style="background:#444444; color:#FFFFFF;font-size:10px; border:#dddddd 1px solid;" >Address</th>
                <th style="background:#444444; color:#FFFFFF;font-size:10px; border:#dddddd 1px solid;" >Zone</th>
                <th style="background:#444444; color:#FFFFFF;font-size:10px; border:#dddddd 1px solid;" >Mobile No</th>
				<th style="background:#444444; color:#FFFFFF;font-size:10px; border:#dddddd 1px solid;" >Clint IP</th>
                <th style="background:#444444; color:#FFFFFF;font-size:10px; border:#dddddd 1px solid;" >Package</th>
                <th style="background:#444444; color:#FFFFFF;font-size:10px; border:#dddddd 1px solid;" >Speed</th>
                <th style="background:#444444; color:#FFFFFF;font-size:10px; border:#dddddd 1px solid;" >Previous Due</th>
                <th style="background:#444444; color:#FFFFFF;font-size:10px; border:#dddddd 1px solid;"> Bill</th>
                <th style="background:#444444; color:#FFFFFF;font-size:10px; border:#dddddd 1px solid;width:15%;" >Total Dues</th>
            </tr>
            </tr>
        </thead>
        <tbody>
		 ...
		 ?> 
            <tr>
                ...
                <td style="font-size:10px; width:10%; border:#dddddd 1px solid;width:10%;"><?php echo $v->details; ?></td>
                ...
                <td style="font-size:10px; border:#dddddd 1px solid; width:10%;"><?php echo $v->mobile; ?></td>
				 ...
				 <td style="font-size:10px; width:10%; border:#dddddd 1px solid;width:10%;"><?php echo $v->Clint_IP; ?></td>
                ...
                <td style="font-size:10px; border:#dddddd 1px solid;width:15%;"><?php echo $v->previus_months_due+$v->connection_charge_due_amount+$v->running_bill; ?></td>
				 
            </tr>
		<?php } } ?>
			<tr>
				
                <td colspan="10" align="right" style="border:#dddddd 1px solid;">Total =</td>
                <td style="border:#dddddd 1px solid;"><?php echo $total_taka; ?></td>
