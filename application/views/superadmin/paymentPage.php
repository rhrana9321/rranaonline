  ...
  <div class="col-md-12" style="margin:15px 0px 15px 0px; padding:0px 15px 0px 0px;">
    ...
    <div class="col-md-10" style="background:#FFFFFF; border:1px solid #999999;">
      ...
      <div class="col-md-12"
        ...
        <div class="col-md-6"> <b>View Payment Information for <?php echo $find_customer_paymentinfo->name; ?></b> </div>
      </div>
          ...
          <table class="table table-bordered table-hover table-striped">
			...
			?>
              ...
              <td><div class="btn-group"> <a class="btn btn-xs btn-info" style="padding:5px;"
                               href="<?php echo site_url('software/Customer_info/edit/' .$find_customer_paymentinfo->custo_id);?>"> <span class="glyphicon glyphicon-edit"></span> Edit </a> <a href="javascript:void(0)" class="btn btn-primary btn-sm hold" id="hold" style="padding:5px">Hold</a> </div></td>
            </tr>
          </table>
        </div>
      </div>
      <div class="row" style="font-size: 12px;">
	  <form id="loadingId" role="form" enctype="multipart/form-data" method="post" action="<?php echo site_url('software/Bill_Collection/payment_action');?>">
	  <input class="form-control" value="<?php echo $find_customer_paymentinfo->custo_id; ?>" style="height: 30px;" type="hidden" name="customer_id">
        ...
        <div class="col-md-3">
          <div class="form-group">
            ...
            <select class="form-control" name="month_name" required id="payment_month">
              <option value=""></option>
        ...
        <div class="col-md-3">
          <div class="form-group">
            ...
            <input name="due_bill_amount" value="<?php echo $find_customer_paymentinfo->previus_months_due; ?>" type="text" class="form-control"
        ...
        <div class="row" style="font-size: 12px;">
          <div class="col-md-3">
            <div class="form-group">
              ...
              <input class="form-control" value="<?php echo date('d/m/Y h:i:s a', time()); ?>" type="text" id="" readonly="">
            </div>
          </div>
          <div class="col-md-3">
            <div class="form-group" style="margin-top: 30px;">
              <div class="checkbox">
                ...
                <b>Send SMS Notification</b> </label>
              </div>
            </div>
          </div>
          <div class="col-md-3">
            <div class="form-group">
              ...
              <input id="amount" class="form-control" autocomplete="off" onKeyPress="return numbersOnly(event)"
                           style="height: 30px;" type="text" name="amount" required="">
          ...
          <div class="col-md-3">
            <div class="form-group">
			  ...
			  <input id="limited" class="form-control" style="height: 30px;" type="hidden" name="limited">
			  
			  
              <input id="discount" class="form-control" autocomplete="off" placeholder="Bonus(optional)" onKeyPress="return numbersOnly(event)"
                           style="height: 30px;" type="text" name="discount">
        ...
        <div class="row" style="font-size: 12px;">
          ...
          <div class="col-md-2">
            <button id="btn_submit" style="padding: 10px !important;margin-top:23%;" type="submit"
						<button type="submit" data-loading-text="<i class='fa fa-spinner fa-spin'></i>Processing..." class="abcd btn btn-success"><span> Add Payment</span></button>
          </div>
        </div>
      </form>
      <hr>
            ...
            <table class="table table-bordered table-hover table-striped" id="datatable">
			  ...
			  ?>
                <tr>
                  ...
                  <td style="text-align: right;"><?php echo $v->month_name; ?> of <?php echo $v->details; ?></td>
                  <td style="text-align: right;"><?php echo $v->amount; ?></td>
                  <td><div class="btn-group" >   <a target="_blank"
                                       href="<?php echo site_url('software/Bill_Collection/Payment_Print/' .$v->payment_id);?>" class="btn btn-xs " style="margin-left: 5px;"> <span style="color: black;" class="glyphicon glyphicon-print"></span> </a> </div></td>
                </tr>
             <?php } } ?> 
...
<script>
 $("#payment_month").change(function(){
	  ...
	  $("#details").val('Additional Payment of month : ' + payment_month);
	});
</script>
<script>
