      ...
      <div class="modal fade" id="addZoneModal" role="dialog">
        <div class="modal-dialog">
          <div class="modal-content">
            ...
            <form method="post"  id="loadingId" action="<?php echo site_url('software/Zone_Info/store');?>">
                ...
                <div class="row" style="padding:0 10px;">
                  ...
                  <div class="col-md-12">
                    <div class="form-group text-center">
                      <button type="submit" data-loading-text="<i class='fa fa-spinner fa-spin'></i>Processing..." class="abc left1_btn left1_btn-1 left1_btn-1c"><span>Insert Zone</span></button>
                    </div>
                  </div>
                </div>
              </div>
