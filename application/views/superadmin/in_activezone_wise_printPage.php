      ...
      <div class="row" id="month_print">
        ...
        <thead>
		 <th colspan="2" style="background:#FFFFFF; color:#000000; text-align:left; font-size:16px; border-right:#FFFFFF 1px solid;" class="col-md-1"><img title="Visit Site" alt="Our logo" src="<?php echo base_url('upload/' .$superdetails->logo_image);?>" width="100" height="45"></th>
				<th colspan="7" style="background:#FFFFFF; color:#000000; text-align:center; font-size:13px; border-left:#FFFFFF 1px solid;" class="col-md-1"> In-active Customer View &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; </th>
            ...
            <tr>
                <th style="background:#444444; color:#FFFFFF;border:#dddddd 1px solid;" class="col-md-1">Clint Name</th>
				...
				<th style="background:#444444; color:#FFFFFF;border:#dddddd 1px solid;" class="col-md-1">Clint IP</th>
                <th style="background:#444444; color:#FFFFFF;border:#dddddd 1px solid;" class="col-md-1">Package</th>
                <th style="background:#444444; color:#FFFFFF;border:#dddddd 1px solid;" class="col-md-1">Speed</th>
                <th style="background:#444444; color:#FFFFFF;border:#dddddd 1px solid;" class="col-md-1">Previous Due</th>
                <th style="background:#444444; color:#FFFFFF;border:#dddddd 1px solid;" class="col-md-1">Running Bill</th>
                <th style="background:#444444; color:#FFFFFF;border:#dddddd 1px solid;" class="col-md-1">Total Dues</th>
            </tr>
            </tr>
        </thead>
        <tbody>
		 ...
		 ?> 
            <tr>
				...
				<td style="border:#dddddd 1px solid;"><?php echo $v->previus_months_due; ?></td>
                <td style="border:#dddddd 1px solid;"><?php echo $v->running_bill; ?></td>
                <td style="border:#dddddd 1px solid;"><?php echo $v->previus_months_due+$v->connection_charge_due_amount+$v->running_bill; ?></td>
